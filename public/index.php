  ...
  <div class="flex-col w-full h-fit items-center bg-img-1 bg-fixed bg-cover bg-center">
    <div class="backdrop-brightness-90 dark:backdrop-brightness-50 h-full">
      <div class="flex mx-auto max-w-5xl px-3 h-full items-center">
        <article class="flex-col md:px-8 mx-auto bg-white bg-opacity-90 rounded-lg my-8 md:my-12">
        ...
        <form action="https://formspree.io/f/xqkngbvo" method="POST">
          <div class="mb-6">
            <label for="email" class="block mb-2 text-sm text-gray-600 dark:text-gray-400">Your Address</label>
            <input type="email" name="email" placeholder="715 Europe St, Baton Rouge, LA 7082" required aria-required="true" aria-placeholder="your@email.com" aria-label="Email" class="w-full px-3 py-2 placeholder-gray-300 dark:bg-gray-400 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-gray-100 focus:border-gray-300" />
          </div>
          <div class="mb-6">
          ...
          <div class="mb-6">
            <button type="submit" role="button" class="w-full mt-4 px-2 py-4 text-white bg-green-500 rounded-md focus:bg-gray-600 focus:outline-none">Send
              Message</button>
          </div>
        </form>
      </div>
...
<div class="grid grid-cols-12 max-w-5xl mx-auto gap-8 lg:gap-12 items-center">
...
<div class="col-span-12 lg:col-span-3 md:mx-auto rounded-xl mx-auto">
<img src="/images/food2-xs.jpg" class="h-72 lg:h-48 rounded-full pl-2 mt-8">
</div>
...
<div class="col-span-12 lg:col-span-4 md:mx-auto rounded-xl md:pb-12 lg:pb-0 mx-auto">
<img src="/images/food1-xs.jpg" class="h-72 lg:h-48 rounded-full pl-2">
</div>
...
<div class="col-span-12 lg:col-span-3 md:mx-auto rounded-xl mx-auto">
<img src="/images/food3-xs.jpg" class="h-72 lg:h-48 rounded-full pl-2 mb-8 lg:mb-0">
</div>
