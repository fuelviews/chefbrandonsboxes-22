...
<main id="main" role="main" class="flex flex-auto flex-col w-full justify-center items-center">
  <div class="flex-col w-full mx-auto px-3 py-16 prose lg:prose-xl dark:prose-invert text-center">
    ...
    <a href="/" class="inline-flex items-center mt-6 px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
      Go back home
    </a>
  </div>
</main>
